...
export default function Navbar() {
  ...
  const NavLinks = () => (
    <>
      <Link 
        href="/learn"
        className={`nav-link cursor-pointer min-[950px]:inline-block block py-4 px-4 min-[950px]:px-0 min-[950px]:py-0 text-lg transition-all ${isHomePage ? 'min-[950px]:text-white/80 min-[950px]:hover:text-white max-[949px]:text-black max-[949px]:hover:bg-gray-50' : 'text-black hover:bg-gray-50 min-[950px]:hover:bg-transparent'}`}
        onClick={() => setIsMobileMenuOpen(false)}
      >
        Learn more
      </Link>
      <a 
        href="https://companeon.io"
        target="_blank"
              ...
              {isConnected ? (
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  >
                    ...
                    <span className="text-black">{isLoading ? 'Connecting...' : 'Connect wallet'}</span>
                  </button>
                </div>
              )}
            </div>
