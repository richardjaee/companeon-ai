...
const endpointMap: { [key: string]: string | undefined } = {
  ...
  PAUSE_AGENT_URL: process.env.PAUSE_AGENT_URL,
  RESUME_AGENT_URL: process.env.RESUME_AGENT_URL,
  GET_AGENT_STATUS_URL: process.env.GET_AGENT_STATUS_URL,
  GET_USER_AGENTS_URL: process.env.GET_USER_AGENTS_URL,
  EXECUTE_AGENT_NOW_URL: process.env.EXECUTE_AGENT_NOW_URL,
